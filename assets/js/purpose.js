    ...
    PurposeStyle = (function () {
        ...
        return {
            colors: {
                ...
                theme: {
                    primary: e.getPropertyValue("--primary") ? e.getPropertyValue("--primary").replace(" ", "") : "#02a0e0",
...
if ($('[data-toggle="widget-calendar"]')[0]) {
    $('[data-toggle="widget-calendar"]').fullCalendar({
        contentHeight: "auto",
        theme: !1,
        buttonIcons: { prev: "fi fi-rr-angle-small-left", next: "fi fi-rr-angle-small-right" },
        header: { right: "next", center: "title, ", left: "prev" },
        defaultDate: "2021-08-01",
        editable: !0,
        events: [
            { title: "Call with Dave", start: "2021-08-18", end: "2021-08-18", className: "bg-red-500" },
            { title: "Lunch meeting", start: "2021-08-21", end: "2021-08-21", className: "bg-yellow-500" },
            // { title: "All day conference", start: "2021-08-29", end: "2021-08-29", className: "bg-green-500" },
            // { title: "Meeting with Mary", start: "2021-9-01", end: "2021-9-01", className: "bg-blue-500" },
            // { title: "Winter Hackaton", start: "2021-9-03", end: "2021-9-03", className: "bg-red-500" },
            // { title: "Digital event", start: "2021-9-07", end: "2021-9-09", className: "bg-yellow-500" },
            // { title: "Marketing event", start: "2021-9-10", end: "2021-9-10", className: "bg-ci-primary" },
            // { title: "Dinner with Family", start: "2021-9-19", end: "2021-9-19", className: "bg-red-500" },
            // { title: "Black Friday", start: "2021-9-23", end: "2021-9-23", className: "bg-blue-500" },
            // { title: "Cyber Week", start: "2021-9-02", end: "2021-9-02", className: "bg-yellow-500" },
        ],
    });
